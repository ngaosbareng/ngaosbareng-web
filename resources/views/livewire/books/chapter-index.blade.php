            ...
            <div class="p-8 lg:p-12">
                        ...
                        @foreach ($chapters as $chapter)
                            ...
                            <a href="{{ route('books.discussions', $chapter) }}"
                                ...
                                <div class="flex items-start justify-between">
                                    ...
                                    {{-- Jumlah Pembahasan --}}
                                    <div class="text-sm font-semibold text-indigo-700 bg-indigo-100 px-4 py-1.5 rounded-full shadow-sm whitespace-nowrap">
                ...
                @else
                    ...
                    <div class="text-center py-16 border-2 border-dashed border-gray-200 rounded-xl bg-gray-50">
                        <svg class="mx-auto h-14 w-14 text-gray-400" fill="none" viewBox="0 0 24 24"
