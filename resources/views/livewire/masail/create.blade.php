    ...
    <div class="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
        <div class="px-4 py-6 sm:px-0">
            <div class="flex justify-between items-center mb-6">
                <div>
                    <h2 class="text-2xl font-bold text-gray-900">Tambah Masail Baru</h2>
                    <p class="text-gray-600 mt-1">Tambahkan pertanyaan baru yang merujuk ke pembahasan dari berbagai kitab</p>
                </div>
            ...
            <form wire:submit.prevent="store" class="space-y-6 bg-white shadow px-4 py-5 sm:rounded-lg sm:p-6">
